...
const plans: PricingPlan[] = [
  ...
  {
    name: 'Pro',
    description: 'Keep your LinkedIn posts fresh & visible',
    price: 9,
    period: 'month',
    popular: true,
    icon: Sparkles,
    ...
    features: [
      '🔄 Auto-refresh hashtags every 24-168 hours',
      'Up to 10 active refresh schedules',
      'Unlimited manual hashtag generations',
      'Custom refresh intervals (12-720 hours)',
      'Automatic old comment deletion',
      'Fresh hashtags posted automatically',
      'Email notifications on each refresh',
